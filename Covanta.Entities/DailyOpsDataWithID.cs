...
namespace Covanta.Entities
{
    ...
    /// </summary>
    public class DailyOpsDataWithID
    {
        ...
        public DailyOpsDataWithID(int Id, string facilityID, DateTime reportingDate, decimal tonsDelivered, decimal tonsProcessed, decimal steamProduced, decimal steamSold, decimal netElectric,
                         string outageTypeBoiler1, decimal downTimeBoiler1, string explanationBoiler1,
                         string outageTypeBoiler2, decimal downTimeBoiler2, string explanationBoiler2,
                         string outageTypeBoiler3, decimal downTimeBoiler3, string explanationBoiler3,
                         string outageTypeBoiler4, decimal downTimeBoiler4, string explanationBoiler4,
                         string outageTypeBoiler5, decimal downTimeBoiler5, string explanationBoiler5,
                         string outageTypeBoiler6, decimal downTimeBoiler6, string explanationBoiler6,
                         string outageTypeTurbGen1, decimal downTimeTurbGen1, string explanationTurbGen1,
                         string outageTypeTurbGen2, decimal downTimeTurbGen2, string explanationTurbGen2,
                         ...
                         string comments, string userRowCreated, string userLastModified, decimal pitInventory)
        {
            ID = Id;
            ...
            UserRowCreated = userLastModified;
        ...
        public DailyOpsDataWithID(int Id)
        {
            ID = Id;
        }
