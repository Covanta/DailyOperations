...
<h2 class="ExceptionsReportHeading">
	Summary
</h2>
...
<asp:GridView ID="HealthSafetyFacilityTypeData" runat="server" AutoGenerateColumns="false"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="Event Type" HeaderStyle-Width="21%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Description" HeaderStyle-Width="51%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
</asp:GridView>
...
<asp:GridView ID="BoilerOutageFacilityTypeData" runat="server" AutoGenerateColumns="false"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="Boiler" HeaderStyle-Width="10%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Status" HeaderStyle-Width="13.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Downtime" HeaderStyle-Width="11.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Explanation" HeaderStyle-Width="22.9%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Cumulative Downtime" HeaderStyle-Width="12.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<%--<asp:TemplateField HeaderText="Cumulative Downtime for Week Ending MM/DD" HeaderStyle-Width="10.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>--%>
		<asp:TemplateField HeaderText="Cumulative Downtime for Month of Month Year" HeaderStyle-Width="10.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
        <asp:TemplateField HeaderText="Estimated Return to Service Date" HeaderStyle-Width="12.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
</asp:GridView>

<h2 class="ExceptionsReportHeading">
	Turbine/Generator Outage Log
</h2>
<asp:GridView ID="TurbineOutageFacilityTypeData" runat="server" AutoGenerateColumns="false"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="Turbine" HeaderStyle-Width="10%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Status" HeaderStyle-Width="13.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Downtime" HeaderStyle-Width="11.4%" ItemStyle-CssClass="TypeRow">
		...
		<asp:TemplateField HeaderText="Monthly Downtime" HeaderStyle-Width="10.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
        <asp:TemplateField HeaderText="Estimated Return to Service Date" HeaderStyle-Width="12.4%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
...
<asp:GridView ID="MetalsSystemsFacilityTypeData" runat="server" AutoGenerateColumns="false"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="System" HeaderStyle-Width="12%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Will ash be reprocessed?" HeaderStyle-Width="12%"
			ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Downtime" HeaderStyle-Width="11%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>               
		<asp:TemplateField HeaderText="Current Event Explanation" HeaderStyle-Width="20%" ItemStyle-CssClass="TypeRow" ItemStyle-HorizontalAlign="Center">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Current Event Cumulative Downtime" HeaderStyle-Width="14%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<%--<asp:TemplateField HeaderText="Weekly Downtime" HeaderStyle-Width="11%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>--%>
		<asp:TemplateField HeaderText="Monthly Downtime" HeaderStyle-Width="11%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Estimated Return to Service Date" HeaderStyle-Width="15%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
</asp:GridView>

<h2 class="ExceptionsReportHeading">
	Critical Assets in Alarm</h2>
...
<h2 class="ExceptionsReportHeading">
	Critical Equipment OOS/Lack of Redundancy 
</h2>
<asp:GridView ID="CommentsFacilityTypeData" runat="server" AutoGenerateColumns="False"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="Comments" HeaderStyle-Width="72%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
</asp:GridView>
...
<asp:GridView ID="FireProtectionFacilityTypeData" runat="server" AutoGenerateColumns="False"
	...
	<Columns>
		...
		<asp:TemplateField HeaderText="Systems Out of Service" HeaderStyle-Width="54%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
		<asp:TemplateField HeaderText="Estimated Return to Service Date" HeaderStyle-Width="18%" ItemStyle-CssClass="TypeRow">
		</asp:TemplateField>
	</Columns>
</asp:GridView>
<br/>
                ...
                <td class="TypeRow" colspan="2">
				    <div>
				        <table cellspacing="0" rules="all" border="1" id="ExceptionsReportData_CommentsFacilityTypeData_ctl02_CommentsData" style="border-collapse:collapse;">
					        <tbody>
                                <tr>
						            <td class="FacilityRow" style="width:20%;"></td><td class="FacilityRow" style="width:80%;">
